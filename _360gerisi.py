if consent_tone == "interested" or consent_tone=="ilgili":
    with open('/content/interested_tr.txt', 'r', encoding='utf-8') as f:
        interested_raw = f.read()
        tone_raw = interested_raw
elif consent_tone == "praise" or consent_tone=="övgülü":
    with open('/content/praise_tr.txt', 'r', encoding='utf-8') as f:
        praise_raw = f.read()
        tone_raw = praise_raw
elif consent_tone == "begging" or consent_tone=="yalvaran":
    with open('/content/begging_tr.txt', 'r', encoding='utf-8') as f:
        begging_raw = f.read()
        tone_raw = begging_raw
elif consent_tone == "english" or consent_tone=="ingilizce":
    with open('/content/tone_eng.txt', 'r', encoding='utf-8') as f:
        eng_raw = f.read()
        tone_raw = eng_raw
